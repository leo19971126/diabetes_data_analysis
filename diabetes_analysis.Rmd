...
Since the numbers are pretty big, so I would have to log10 the data 
...
# clean_diabetes %>% 
#   group_by(Outcome) %>% 
#   summarise(n = n(), mean_glucose = mean(Glucose), median_glucose = median(Glucose), std_dev = sd(Glucose))
...
null_distribution_diabetes <- test %>%
...
visualize(null_distribution_diabetes)
